...
Para obtener las predicciones finales, sigue estos pasos:
 ...
 Ubicación del código:
   Abre el archivo Evaluacion.ipynb utilizando Jupyter Notebook, Jupyter Lab o tu IDE de preferencia.
 ...
 Ejecución del pipeline:
   ...
   Obtención de Resultados:
     Una vez finalizada la ejecución, el script rellenará un archivo ,cogiendo las columnas del original de test añadiendo la columna t con las predicciones. Encontrarás tus resultados en:
